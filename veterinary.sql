...
VALUES
    ...
    (3, 'Antonio', 'Gonzales', '789 Oak St, Cebvu', '555-123-4567', 'antonio@example.com'),
    ...
    (8, 'Carmen', 'Ferandez', '222 Birch St, Taguig', '333-222-1111', 'carmen@example.com'),
    (9, 'Pedro', 'Santillan', '888 Spruce St, Bacolod', '888-777-6666' 'pedro@example.com'),
    (10, 'Sofia', 'Villanueva', '7777 Walnut St, Iloilo', '111-999-3333', 'sofia@example.com');

INSERT INTO animals(animalid, name, species,breed, dateofbirth, gender, color,ownerid)
VALUES
    (1, 'Fido', 'Dog', 'Golden Retriever', '2018-03-15', 'Male', 'Golden', 1),
    (2, 'Whiskers', 'Cat', 'Siamese', '2019-07-20', 'Female', 'Cream', 2),
    (3, 'Rocky', 'Dog', 'German Shpered', '2017-05-10', 'Male', 'Black and Tan', 3),
    (4, 'Fluppy' 'Cat', 'Persian', '2020-01-30', 'Male', 'White', 4),
    ...
    (9, 'Max', 'Dog', 'Dachsund', '2020-07-14', 'Male' 'Black and Tan', 9),
    (10. 'Cleo', 'Cat', 'Ragdoli', '2019-12-22', 'Female', 'Seal Point', 10);

INSERT INTO appointments (appointid, animalid, appointdate, reason)
VALUES 
(1, 1, '2023-01-05', 'Annual check-up'),
(2, 2, '2023-01-10', 'Vaccination'),
(3, 3, '2023-02-02', 'Injuty assessment'),
(4, 4, '2023-02-15', 'Dental cleaning'),
(5, 5, '2023-03-10', 'Skin codition'),
(6, 6, '2023-03-10', 'Cheack for fleas'),
